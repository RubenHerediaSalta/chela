        ...
        <div className="lg:mx-auto">
          <div className=" lg:p-6 p-3">
            <motion.img
              ...
              className="w-72 h-82 h-72 flex mt-20 object-cover mx-auto"
              src="/img/chela50.png"
              alt=""
            />

            <div className="  flex-col md:flex-row   my-4 flex items-center md:justify-between">
              <div className=" sm:order-2   max-md:mt-10 flex md:block md:flex-row items-center  flex-col md:order-1 order-2">
                <h1 className="text-6xl font-custom text-center text-[#FFD700]">
                  Festejemos Juntos
                </h1>
                ...
                <motion.p
                  ...
                  className="  text-lg text-center  my-3 text-[#FFD700]"
                >
                  La mayor alegría, para mí, sería tenerte a mi lado
                  compartiendo este día tan especial.
                </motion.p>
                ...
                <div>
                  <h2 className=" text-4xl text-center text-[#FFD700] font-custom ">
                    Sábado 16 de diciembre
                  </h2>
                  <h4 className=" text-2xl text-center text-[#FFD700] font-custom ">
                    21:30 hs
                  </h4>
                  <h2 className=" text-4xl text-center text-[#FFD700] font-custom ">
                    Hotel Asturias - Cafayate
                  </h2>
                  <p className="text-center text-[#FFD700] text-lg">
                ...
                <div className="flex justify-center gap-x-2 my-6 mx-auto">
                  ...
                  >
                    <div className="bg-[#FFD700] h-6 w-100 w-fit px-3 py-6 rounded-full flex items-center justify-center gap-x-2">
                ...
                <div className="mx-auto max-w-md">
                  <div>
                    <h2 className=" text-6xl text-center font-custom text-[#FFD700] ">
                      Tu compañía es el regalo más preciado.
                    </h2>
                    <p className="text-center mt-3 text-[#FFD700] text-lg">
                ...
                <div>
                  <h2 className=" text-6xl text-center text-[#FFD700] font-custom">
                    Agradezco de antemano tu amor y amistad.<br></br> Con
                    aprecio,
                    <motion.img
                      initial={{ x: 100, opacity: 0, filter: "blur(50px)" }}
                      animate={{
